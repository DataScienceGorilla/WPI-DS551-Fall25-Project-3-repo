...
class Agent_DQN(Agent):
    def __init__(self, env, args):
        ...
        self.buffer_size = 40000  # Size of the replay buffer
        self.batch_size = 32       # Batch size for training
        self.gamma = 0.99          # Discount factor
        self.learning_rate = 0.0001 # Learning rate for the optimizer
        self.target_update_freq = 8000 # How often to update the target network (in steps)
        ...
        self.n_episodes = 2000  # Total number of episodes to train for
